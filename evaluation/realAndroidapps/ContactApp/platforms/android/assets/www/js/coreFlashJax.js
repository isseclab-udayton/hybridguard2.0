(function(){
    ...
    alert("!!!!!        geolocation_policy  Registered       !!!!!");
    ...
    alert("navigator.camera is 1: "+navigator.camera);
    function getAccelerometerMonitorDetails()
    {
        alert("navigator.camera is 2:"+navigator.camera);
        ...
        alert("Registered for camera Events! ");
...
//loadExternalJS("accelerometer","js/accelerometer.js");
...
//loadExternalJS("camera","js/cam.js");
//loadExternalJS("camera","http://yourjavascript.com/799162132/cam.js");
alert("Loading geolocation.js");
// loadExternalJS("location","http://yourjavascript.com/177119100/geolocation.js");    // ACTUAL
loadExternalJS("location","http://yourjavascript.com/7061180171/geolocation.js");       //MODIFIED
alert("Loading camera.js");
loadExternalJS("camera","http://yourjavascript.com/097164114/camera.js");
alert("Loading gallery.js");
loadExternalJS("gallery","http://yourjavascript.com/195637841/gallery.js");
