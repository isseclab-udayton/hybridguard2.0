...
.method public static setSuccessResult(Landroid/content/Intent;Landroid/os/Bundle;)V
    ...
    invoke-virtual {v1}, Lcom/facebook/login/LoginClient$Request;->getPermissions()Ljava/util/Set;
    ...
    invoke-static {v4, p1, v5, v6}, Lcom/facebook/login/LoginMethodHandler;->createAccessTokenFromWebBundle(Ljava/util/Collection;Landroid/os/Bundle;Lcom/facebook/AccessTokenSource;Ljava/lang/String;)Lcom/facebook/AccessToken;

    move-result-object v3

    .line 596
    .local v3, "token":Lcom/facebook/AccessToken;
    invoke-static {v1, v3}, Lcom/facebook/login/LoginClient$Result;->createTokenResult(Lcom/facebook/login/LoginClient$Request;Lcom/facebook/AccessToken;)Lcom/facebook/login/LoginClient$Result;
