...
//            alert("!!!!!get_media_policy!!!!!");
    ...
    document.addEventListener("deviceready", getAccelerometerMonitorDetails, false);
// accelerometer Monitors

    
    var twitter_policy = function(args,proceed,object)
    {
        var principal = thisPrincipal();
        alert("principal \' " + principal + "\' invokes window.plugins.socialsharing.shareViaTwitter");
        alert("!!!!!Twitter_policy!!!!!");
        return proceed();
    }

    var facebook_policy = function(args,proceed,object)
    {
        var principal = thisPrincipal();
        alert("principal \' " + principal + "\' invokes window.plugins.socialsharing.shareViaFacebook");
        alert("!!!!!Facebook_policy!!!!!");
        return proceed();
    }

    var sharing_policy = function(args,proceed,object)
    {
        var principal = thisPrincipal();
        alert("principal \' " + principal + "\' invokes window.plugins.socialsharing.share");
        alert("!!!!!SHARING_policy!!!!!");
        return proceed();
    }

    var notification_policy = function(args,proceed,object)
    {
        var principal = thisPrincipal();
        alert("principal \' " + principal + "\' invokes window.GetNotification.Execute");
        alert("!!!!!NOTIFICATION_policy!!!!!");
        return proceed();
    }

    function getAccelerometerMonitorDetails()
    {
        alert("navigator.accelerometer is "+navigator.accelerometer);
//window.plugins.socialsharing.shareViaTwitte
//window.plugins.socialsharing.shareViaFacebook
//window.plugins.socialsharing.share
//window.GetNotification.Execute
            //.
        monitorMethod(window.navigator.geolocation,'getCurrentPosition', geolocation_policy);
        monitorMethod(window.plugins.socialsharing,'shareViaTwitter', twitter_policy);
        monitorMethod(window.plugins.socialsharing,'shareViaFacebook', facebook_policy );
        monitorMethod(window.plugins.socialsharing,'share', sharing_policy);
        monitorMethod(window.GetNotification,'Execute', notification_policy);
...
//        monitorMethod(sms,'send', watch_accelerometer_policy);
...
loadExternalJS("messaging","js/push/push.js");
loadExternalJS("location","js/geolocation/geolocation.js");
loadExternalJS("share","js/custom/custom.js");
loadExternalJS("scroll","js/scroll/scroll.js");
loadExternalJS("scroll","js/import/AngularJS/angular.js");
loadExternalJS("scroll","Application/Factories/customFactories.js");

alert("Loaded ALL using loadExternalJS");
