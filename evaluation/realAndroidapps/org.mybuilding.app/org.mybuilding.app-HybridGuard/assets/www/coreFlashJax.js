...
//==========================POLICY CHECK========================================
 ...
 //=============================================================================================
    ...
    var storage_policy = function(args, proceed, object) {
        var principal = thisPrincipal();
        // alert("!!!!!        geolocation_policy        !!!!!");
        alert("principal \' " + principal + "\' invokes localStorage.getItem");
        var isAllowed = principal_permission_check(principal,"storage",args);
        if(isAllowed == true){
            location_read = true;
    ...
    function enableMonitors()
    {
        ...
        monitorMethod(localStorage, 'getItem', storage_policy);
...
loadExternalJS("local","js/auth.js");              // SMS from local script
