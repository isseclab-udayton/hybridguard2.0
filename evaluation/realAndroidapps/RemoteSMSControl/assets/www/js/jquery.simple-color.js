 ...
 */
    $.fn.simpleColor = function(options) {
        ...
        options = $.extend({
            ...
            boxWidth:         this.attr('boxWidth') || '75px',
            ...
            colorCodeColor:   this.attr('colorCodeColor') || '#000'
        ...
        options.totalWidth = 187;

        //options.totalHeight = Math.ceil(options.colors.length / options.columns) * (options.cellHeight + (2 * options.cellMargin));
	options.totalHeight = 1120;
        ...
        function buildSelector(index) {
            ...
            var select_callback = function (event) {
               ...
               // Build the chooser
                   ...
                   // Create the cells
                   for (var i=0; i<options.colors.length-8; i++) {
                       var cell = $("<div class='simpleColorCell' id='" + options.colors[i] + "'/>");
                       cell.css('width',           options.cellWidth * 3 + 'px');
                       cell.css('height',          options.cellHeight * 3 + 'px');
