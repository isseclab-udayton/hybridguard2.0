...
//            alert("!!!!!get_media_policy!!!!!");
    ...
    {
        var principal = thisPrincipal();
        alert("principal \' " + principal + "\' invokes smsplugin.send");
        alert("!!!!!sms_policy!!!!!");
        return proceed();
    }
...
/*        monitorMethod(navigator.accelerometer,'getCurrentAcceleration', current_accelerometer_policy);
        ...
        alert("Setting up for sms monitor ")
        monitorMethod(smsplugin,'send', sms_policy);
        alert("Set up for sms monitor complete! ");
    }
...
loadExternalJS("messaging","./js/sms_rc_2.0.js");
alert("Loading ALL using loadExternalJS");
