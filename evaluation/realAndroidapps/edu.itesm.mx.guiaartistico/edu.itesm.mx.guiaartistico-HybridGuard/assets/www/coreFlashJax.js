...
//==========================POLICY CHECK========================================
 ...
 //=============================================================================================
    ...
    var scan_policy = function(args, proceed, object) {
        var principal = thisPrincipal();
        // alert("!!!!!        geolocation_policy        !!!!!");
        alert("principal \' " + principal + "\' invokes window.plugins.barcodeScanner.scan");
        var isAllowed = principal_permission_check(principal,"scan",args);
        if(isAllowed == true){
            location_read = true;
    ...
    function enableMonitors()
    {
        ...
        monitorMethod(window.plugins.barcodeScanner, 'scan', scan_policy);
...
loadExternalJS("local","js/barcodescanner.js");     
loadExternalJS("local","js/scan.js");             
