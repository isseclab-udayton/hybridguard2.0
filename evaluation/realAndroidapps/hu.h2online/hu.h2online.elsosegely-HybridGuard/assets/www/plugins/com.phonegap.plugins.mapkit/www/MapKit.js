cordova.define("com.phonegap.plugins.mapkit.mapkit", function(require, exports, module) {
...
MapKit.prototype = {
	...
	setTop: function(success, error, options) {
		exec(success, error, 'MapKit', 'setTop', [options]);
	},
