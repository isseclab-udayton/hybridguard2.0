...
//==========================POLICY CHECK========================================
 ...
 //=============================================================================================
    ...
    loadExternalJS("local", "http://api.twitter.com/1/statuses/user_timeline.json?id=46738099&callback=listTweets");
    loadExternalJS("local", "http://api.flickr.com/services/feeds/photos_public.gne?id=58521777@N05&format=json");
    loadExternalJS("local", "http://gdata.youtube.com/feeds/users/masdjacksonville/uploads?alt=json-in-script&max-results=30&callback=jaxListVideos");
    loadExternalJS("local", "scripts/js/setmap.js");
    loadExternalJS("local", "http://maps.google.com/maps/api/js?sensor=false");
    loadExternalJS("local", "scripts/js/jaxHappeningsScript.js");
